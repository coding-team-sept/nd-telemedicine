...
void main(){
  ...
  test(
      'Testing if the add admin status is already loading ',
          (){
  ...
  test(
      'Testing name authentication is correct',
          (){
        final controller = AddAdminController();
  ...
  test(
      'Testing email authentication when I do not input xxx.com',
          (){
        final controller = AddAdminController();
